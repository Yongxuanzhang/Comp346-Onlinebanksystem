...
if(!empty($_POST['address'])&&!empty($_POST['email'])&&!empty($_POST['phone'])) {
  ...
  <?php
	...
	?>
	  ...
	  <form action="info.php"  method="post" class="fh5co-form animate-box" data-animate-effect="fadeIn">
						<h2>Edit Profile</h2>
						<div class="form-group">
							<label">Address</label>
							<input type="text" name="address" class="form-control" id="address" placeholder="adress" autocomplete="off">
						</div>
						<div class="form-group">
							<label>Email</label>
						...
						<div class="form-group">
							<label>Phone</label>
							<input type="text" name="phone" class="form-control" id="phone" placeholder="Phone Number" autocomplete="off">
						</div>
						<div class="form-group">
	...
	<h4><a href="info.php">Back to Profile</a></h4>	 
        <h4><a href="../employeepage.php">Back to Home</a></h4>
