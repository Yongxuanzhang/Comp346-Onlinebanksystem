...
$records = $db->prepare('SELECT employee_id,password,name FROM Employee WHERE employee_id = :employee_id;');
  
  //$records = $db->prepare('SELECT employee_id,password,name FROM employee WHERE employee_id = :employee_id;');
  $records->bindParam(':employee_id', $_POST['employee_id']);
  $records->execute();
...
?>
<?php
       setcookie('mycookie1',$_POST['employee_id']);
	...
	<div class="container topbottom">
		<div class="row-fluid">
			...
			<div class="span7 homeabout">
				<div class="person">
					<span class="name">Hi <?= $userna; ?></span>
				</div>
