...
<?php
       setcookie('mycookie1',$_POST['id'],time()+3600);
	   setcookie('mycookie2',$_POST['password'],time()+3600);
?>
<?php
...
//echo $_POST['id'];
//echo $_POST['password'];
	$records = $db->prepare('SELECT id,password,name FROM client WHERE id = :id;');
  
  //$records = $db->prepare('SELECT id,password,account_number,name FROM account,client WHERE id = :id');
...
$conn = mysqli_connect($server,$username,$password) ;
		...
		//echo $client;
		mysqli_select_db($conn,'ece352_2');
				...
				<div class="navigation">
					<div>
						<ul>
							...
							<li>
								<img src="img/portfolio-icon.png">
								<a href="movemoney.html">Transfer money</a>
							</li>
							<li>
